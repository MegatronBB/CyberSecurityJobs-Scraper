# -*- coding: utf-8 -*-
"""FinalCyberSecurityJobScraper.ipynb
...
import requests  # Script Updated 09.16.2024
import json
import csv
...
for job in jobs:
    ...
    employer_logo = job.get('employer_logo', 'N/A')
    if employer_logo: # Check if employer_logo is not None
        employer_logo = employer_logo.strip()
    ...
    if job_state: # Check if job_state is not None
